...
class LoadSavedLevelMenu(
    ...
    private fun loadFile(newFile: File) {
        ...
        val newContainer: Container = Container(newSoundSystem, SimpleTimingProvider {
            ...
            true
        }, GlobalContainerSettings(main.settings.forceTexturePack.getOrCompute(), main.settings.forceTilesetPalette.getOrCompute(), main.settings.forceSignLanguage.getOrCompute(), main.settings.reducedMotion.getOrCompute()))
