...
//    val pistonFaceZColor: Var<Color> = Var(Color(1f, 1f, 1f, 1f))
    ...
    val signP: TintedRegion = TintedRegion("sign_p")
    val signPShadow: TintedRegion = TintedRegion("sign_p_shadow", signShadowColor)
    val signR: TintedRegion = TintedRegion("sign_r")
    val signRShadow: TintedRegion = TintedRegion("sign_r_shadow", signShadowColor)
    val signE: TintedRegion = TintedRegion("sign_e")
    val signEShadow: TintedRegion = TintedRegion("sign_e_shadow", signShadowColor)
    val signS: TintedRegion = TintedRegion("sign_s")
    val signSShadow: TintedRegion = TintedRegion("sign_s_shadow", signShadowColor)
