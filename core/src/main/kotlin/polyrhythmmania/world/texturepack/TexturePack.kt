...
open class StockTexturePack(id: String, deprecatedIDs: Set<String>, val regionMap: TextureRegionMap)
    ...
    init {
        ...
        add(PackTexRegion.create("sign_p", regionMap.getOrNull("sign_p")))
        add(PackTexRegion.create("sign_p_shadow", regionMap.getOrNull("sign_p_shadow")))
        add(PackTexRegion.create("sign_r", regionMap.getOrNull("sign_r")))
        add(PackTexRegion.create("sign_r_shadow", regionMap.getOrNull("sign_r_shadow")))
        add(PackTexRegion.create("sign_e", regionMap.getOrNull("sign_e")))
        add(PackTexRegion.create("sign_e_shadow", regionMap.getOrNull("sign_e_shadow")))
        add(PackTexRegion.create("sign_s", regionMap.getOrNull("sign_s")))
        add(PackTexRegion.create("sign_s_shadow", regionMap.getOrNull("sign_s_shadow")))
