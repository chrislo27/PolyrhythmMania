 ...
 */
class DecodingMusicSample(
        val randomAccessFile: RandomAccessFile,
        val fileChannel: FileChannel, sampleRate: Float = 44_100f, nChannels: Int = 2
     ...
     * 
     * This should be called if the backing [randomAccessFile] or [byteChannel] has new data added.
     */
    fun updateFilesize() {
