...
class InitialAssetLoader : IAssetLoader {
    override fun addManagedAssets(manager: AssetManager) {
        ...
        AssetRegistry.loadAsset<Texture>("lighttest", "textures/world/lighttest.tga", linearTexture()) // FIXME remove later
        AssetRegistry.loadAsset<Texture>("lighttest2", "textures/world/lighttest2.tga") // FIXME remove later
