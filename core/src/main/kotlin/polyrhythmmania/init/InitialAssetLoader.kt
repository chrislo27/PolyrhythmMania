...
class InitialAssetLoader : IAssetLoader {
    override fun addManagedAssets(manager: AssetManager) {
        ...
        AssetRegistry.loadAsset<Texture>("mainmenu_bg_storymode_piston", "textures/mainmenu/storymode/desktop_piston.png")
        AssetRegistry.loadAsset<Texture>("mainmenu_bg_storymode_tube", "textures/mainmenu/storymode/tube.png")
