...
import polyrhythmmania.gamemodes.endlessmode.RowPattern

/**
 * NOTE: This pattern repository is kept entirely separate from [EndlessPatterns] so changes to one do not
 * inadvertently affect the other. 
 */
object BossInputPatterns {
    ...
    val firstPattern: Pattern =
            """P---P---##
              |##P---P---""".trimMargin("|").parsePattern(Difficulty.VERY_EASY, flippable = false)
