...
class FirstContractGameMode(main: PRManiaGame) : StoryGameMode(main) {   
    ...
    private val practiceSection1: PracticeSection = PracticeSection(engine)
    private val practiceSection2: PracticeSection = PracticeSection(engine)
    private val practiceSection3: PracticeSection = PracticeSection(engine)
