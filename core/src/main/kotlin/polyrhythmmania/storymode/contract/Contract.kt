...
data class Contract(
    ...
    constructor(
            id: String, conditions: List<Condition>, requester: Requester, jingleType: JingleType, song: SongInfo?,
            ...
            StoryL10N.getVar("contract.tagline.$id"), conditions, requester, jingleType, song, minimumScore, gamemodeFactory
    )
