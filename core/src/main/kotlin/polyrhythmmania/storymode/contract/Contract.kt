...
data class Contract(
    ...
    constructor(
        ...
        id, Localization.getVar("contract.$id.name"),
        if (noListingName) null else Localization.getVar("contract.$id.listingName"),
        Localization.getVar("contract.$id.desc"), Localization.getVar("contract.$id.tagline"),
    ...
    constructor(
        ...
        id, requester, jingleType, attribution, minimumScore, extraConditions, skipAfterNFailures, noListingName,
