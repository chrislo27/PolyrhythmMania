...
data class SongNameAndSource(
    val songName: String,
    val songSourceMaterial: String?,
    val songNameWithLineBreaks: String = songName,
) {
...
data class SongInfo(
    ...
    companion object {
        ...
        const val ARTIST_GENERIC: String = "GENERIC"
        ...
        const val SRC_POLYRHYTHM_MANIA: String = "Polyrhythm Mania"

        fun tengoku(
            songName: String,
            otherAliases: List<SongNameAndSource> = emptyList(),
            songNameWithLineBreaks: String = songName,
        ): SongInfo {
        ...
        fun prmaniaGeneric(
            ...
            return SongInfo(
                SongNameAndSource(songName, SRC_POLYRHYTHM_MANIA, songNameWithLineBreaks),
                ARTIST_GENERIC,
                otherAliases
            )
        }
