...
object Contracts {
    ...
    init {
        ...
        add(Contract(ID_BOSS, Requester.TIM, JingleType.NONE, null /* TODO add attribution */, 0, skipAfterNFailures = NOT_ALLOWED_TO_SKIP, gamemodeFactory = StoryBossGameMode.getFactory()))
