...
class StoryAssetLoader : IAssetLoader {
    override fun addManagedAssets(manager: AssetManager) {
        ...
        StoryAssets.loadAsset<Texture>("desk_bg_piston_background", "story/textures/desk/bg/piston_background.png")
        StoryAssets.loadAsset<Texture>("desk_bg_pistons_0", "story/textures/desk/bg/pistons_0.png")
        StoryAssets.loadAsset<Texture>("desk_bg_pistons_1", "story/textures/desk/bg/pistons_1.png")
        StoryAssets.loadAsset<Texture>("desk_bg_pistons_2", "story/textures/desk/bg/pistons_2.png")
        StoryAssets.loadAsset<Texture>("desk_bg_pistons_3", "story/textures/desk/bg/pistons_3.png")
        StoryAssets.loadAsset<Texture>("desk_bg_pistons_4", "story/textures/desk/bg/pistons_4.png")
        StoryAssets.loadAsset<Texture>("desk_bg_pistons_5", "story/textures/desk/bg/pistons_5.png")
        StoryAssets.loadAsset<Texture>("desk_bg_pistons_6", "story/textures/desk/bg/pistons_6.png")
        StoryAssets.loadAsset<Texture>("desk_bg_pistons_7", "story/textures/desk/bg/pistons_7.png")
        StoryAssets.loadAsset<Texture>("desk_bg_pistons_8", "story/textures/desk/bg/pistons_8.png")
        StoryAssets.loadAsset<Texture>("desk_bg_pistons_9", "story/textures/desk/bg/pistons_9.png")
