...
class TexturePackEditDialog(
    ...
    companion object {
        val LIST_ENTRIES: List<ListEntry> = listOf(
                ...
                ListEntry.Region("sign_p"),
                ListEntry.Region("sign_p_shadow"),
                ListEntry.Region("sign_r"),
                ListEntry.Region("sign_r_shadow"),
                ListEntry.Region("sign_e"),
                ListEntry.Region("sign_e_shadow"),
                ListEntry.Region("sign_s"),
                ListEntry.Region("sign_s_shadow"),
