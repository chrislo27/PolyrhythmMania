...
object Instantiators {
    ...
    init {
        ...
        //region Basic instantiators
        endStateInstantiator = Instantiator(
            "endState", BlockEndState::class.java,
        ...
        add(CATEGORY_CORE, Instantiator(
            "spawnPattern", BlockSpawnPattern::class.java,
        ...
        add(CATEGORY_CORE, Instantiator(
            "deployRod", BlockDeployRod::class.java,
        ...
        add(CATEGORY_CORE, Instantiator(
            "retractPistons", BlockRetractPistons::class.java,
            ...
            BlockRetractPistons.BLOCK_TYPES
        ) { engine ->
            BlockRetractPistons(engine)
        })
        add(CATEGORY_CORE, Instantiator(
            "despawnPattern", BlockDespawnPattern::class.java,
            ...
            BlockDespawnPattern.BLOCK_TYPES
        ) { engine ->
            BlockDespawnPattern(engine)
        })
        add(CATEGORY_CORE, Instantiator(
            "skillStar", BlockSkillStar::class.java,
        ...
        //region FX instantiators
        add(CATEGORY_FX, Instantiator(
            "condApplause", BlockCondApplause::class.java,
            ...
            BlockCondApplause.BLOCK_TYPES
        ) { engine ->
            BlockCondApplause(engine)
        })
        add(CATEGORY_FX, Instantiator(
            "paletteChange", BlockPaletteChange::class.java,
            ...
            BlockPaletteChange.BLOCK_TYPES, deprecatedIDs = setOf("tilesetChange")
        ) { engine ->
            BlockPaletteChange(engine)
        })
        add(CATEGORY_FX, Instantiator(
            "texPackChange", BlockTexPackChange::class.java,
            ...
            BlockTexPackChange.BLOCK_TYPES
        ) { engine ->
            BlockTexPackChange(engine)
        })
        add(CATEGORY_FX, Instantiator(
            "textbox", BlockTextbox::class.java,
            ...
            BlockTextbox.BLOCK_TYPES
        ) { engine ->
            BlockTextbox(engine)
        })
        add(CATEGORY_FX, Instantiator(
            "subtitle", BlockSubtitle::class.java,
            ...
            BlockSubtitle.BLOCK_TYPES
        ) { engine ->
            BlockSubtitle(engine)
        })
        add(CATEGORY_FX, Instantiator(
            "songInfoCard", BlockSongInfoCard::class.java,
            ...
            BlockSongInfoCard.BLOCK_TYPES
        ) { engine ->
            BlockSongInfoCard(engine)
        })
        add(CATEGORY_FX, Instantiator(
            "zoom", BlockZoom::class.java,
            ...
            BlockZoom.BLOCK_TYPES
        ) { engine ->
            BlockZoom(engine)
        })
        //endregion

        //region Spotlight instantiators
        add(CATEGORY_SPOTLIGHTS, Instantiator(
            "spotlightSwitch", BlockSpotlightSwitch::class.java,
            ...
            BlockSpotlightSwitch.BLOCK_TYPES
        ) { engine ->
            BlockSpotlightSwitch(engine)
        })
        add(CATEGORY_SPOTLIGHTS, Instantiator(
            "spotlightAdvanced", BlockSpotlightAdvanced::class.java,
            ...
            BlockSpotlightAdvanced.BLOCK_TYPES
        ) { engine ->
            BlockSpotlightAdvanced(engine)
        })
        //endregion

        //region Advanced instantiators
        add(CATEGORY_ADVANCED, Instantiator(
            "selectiveSpawn", BlockSelectiveSpawnPattern::class.java,
            ...
            BlockSelectiveSpawnPattern.BLOCK_TYPES
        ) { engine ->
        ...
        //region Story Mode instantiators
        add(CATEGORY_STORYMODE, Instantiator(
            "storyMode_memo", BlockMemoStoryMode::class.java,
            ...
            BlockMemoStoryMode.BLOCK_TYPES, editorFlags = EnumSet.of(EditorSpecialFlags.STORY_MODE)
        ) { engine ->
            BlockMemoStoryMode(engine)
        })
        add(CATEGORY_STORYMODE, Instantiator(
            "storyMode_deployRod", BlockDeployRodStoryMode::class.java,
            ...
            BlockDeployRod.BLOCK_TYPES, editorFlags = EnumSet.of(EditorSpecialFlags.STORY_MODE)
        ) { engine ->
            BlockDeployRodStoryMode(engine)
        })
        add(CATEGORY_STORYMODE, Instantiator(
            "storyMode_spawnPattern", BlockSpawnPatternStoryMode::class.java,
            ...
            BlockSpawnPattern.BLOCK_TYPES, editorFlags = EnumSet.of(EditorSpecialFlags.STORY_MODE)
        ) { engine ->
            BlockSpawnPatternStoryMode(engine)
        })
        add(CATEGORY_STORYMODE, Instantiator(
            "storyMode_panCamera", Block8BallCamera::class.java,
            ...
            Block8BallCamera.BLOCK_TYPES, editorFlags = EnumSet.of(EditorSpecialFlags.STORY_MODE)
        ) { engine ->
            Block8BallCamera(engine)
        })
        add(CATEGORY_STORYMODE, Instantiator(
            "storyMode_monsterGoalPoints_start",
            BlockMonsterGoalPointStart::class.java,
            ...
            BlockMonsterGoalPoints.BLOCK_TYPES,
            editorFlags = EnumSet.of(EditorSpecialFlags.STORY_MODE),
            onlyOne = true
        ) { engine ->
            BlockMonsterGoalPointStart(engine)
        })
        add(CATEGORY_STORYMODE, Instantiator(
            "storyMode_monsterGoalPoints_end",
            BlockMonsterGoalPointEnd::class.java,
